...
public interface AuthMapper {
  @Select("SELECT \"id\",\"phone\",\"passwordHash\",\"createdAt\",\"updatedAt\" FROM \"User\" WHERE \"phone\" = #{phone} LIMIT 1") UserRecord findUserByPhone(String phone);
  @Select("SELECT \"id\",\"phone\",\"passwordHash\",\"createdAt\",\"updatedAt\" FROM \"User\" WHERE \"id\" = #{id} LIMIT 1") UserRecord findUserById(String id);
