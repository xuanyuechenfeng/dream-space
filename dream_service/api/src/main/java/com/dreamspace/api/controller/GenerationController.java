...
@RestController
@RequestMapping("/dream_web/generation")
public class GenerationController {
  ...
  @GetMapping("/options")
  GenerationService.Options options() { return service.options(); }
  ...
  GenerationService.PlanView plan(@PathVariable String taskId, HttpServletRequest request) {
    return service.getPlan(user(request), taskId);
  }
