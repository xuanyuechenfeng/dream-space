...
final class AdminApplicationSql {
  ...
  public static String listTasks(java.util.Map<String,Object> params) {
    return TASK_SELECT + taskFilters(params) + " ORDER BY t.\"createdAt\" DESC LIMIT #{limit} OFFSET #{offset}";
  }
  public static String countTasks(java.util.Map<String,Object> params) {
  ...
  private static String taskFilters(java.util.Map<String,Object> params) {
  ...
  public static String listInspirations(java.util.Map<String,Object> params) {
    return INSPIRATION_SELECT + inspirationFilters(params) + " ORDER BY \"updatedAt\" DESC,\"id\" LIMIT #{limit} OFFSET #{offset}";
  }
  public static String countInspirations(java.util.Map<String,Object> params) {
    return "SELECT COUNT(*) FROM \"Inspiration\"" + inspirationFilters(params);
  }
  private static String inspirationFilters(java.util.Map<String,Object> params) {
    StringBuilder sql = new StringBuilder(" WHERE 1=1");
  ...
  private static boolean present(java.util.Map<String,Object> params, String key) {
