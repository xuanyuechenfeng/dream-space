...
public class AdminAuthController {
  ...
  public AdminAuthController(AdminAuthService service, com.dreamspace.common.persistence.config.DreamSpaceProperties props) { this.service = service; secure = props.isProduction(); }
