...
import { ref } from "vue";
import { api, type AuthSession, type CodeResponse, type LoginPayload, type PasswordLoginPayload } from "@/api/client";
...
export const useAuthStore = defineStore("auth", () => {
  ...
  return { session, loading, error, loadSession, sendCode, login, passwordLogin, logout };
});
